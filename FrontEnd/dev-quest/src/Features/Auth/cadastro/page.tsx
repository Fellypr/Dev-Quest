import {AuthFormRegisterSide} from "@/Features/Auth/cadastro/components/AuthFormRegisterSide"
import {AuthRegisterForm} from "@/Features/Auth/cadastro/components/AuthRegisterForm"
export function AuthCadastroPage(){
    return(
